    ...
    <div class="container justify-content-center">
      ...
      <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-8"> <span class="text-info-users display-5"> <h5 class="text-muted "> {{ $article->titre }}</h5></span></div>
         
 
           <div class="col-md-4 d-flex justify-content-center align-items-center"> <span class="text-info-users text-muted display-5">Lire aussi</span></div>
